...
$cons = mysqli_query($conn,"SELECT * FROM documentos WHERE id_propietario = $nombre");
while($reg = mysqli_fetch_array($cons)){
    ...
    <div class="btndown">
    <h3><a href="documentos/'.$reg['id_propietario'].'/'.$reg['nombre'].'"  download="'.$reg['nombre'].'">Descargar</a></h3>
    </div>
    </div>
